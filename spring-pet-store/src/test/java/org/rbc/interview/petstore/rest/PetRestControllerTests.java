...
import org.rbc.interview.petstore.service.storeService.ApplicationTestConfig;
...
public class PetRestControllerTests {
    ...
    public void testGetPetSuccess() throws Exception {
    	given(this.storeService.findPetById(1)).willReturn(pets.get(0));
    ...
    public void testGetPetNotFound() throws Exception {
    	given(this.storeService.findPetById(-1)).willReturn(null);
    ...
    public void testGetAllPetsSuccess() throws Exception {
    	given(this.storeService.findAllPets()).willReturn(pets);
